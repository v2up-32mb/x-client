...
// DefaultBackpressureLimitBytes 全局写队列背压阈值默认值（16MB，上传/下载大流量时更不易触发）
const DefaultBackpressureLimitBytes = 16 << 20
...
func DefaultConfig() *Config {
	return &Config{
		...
		BackpressureLimitBytes:  DefaultBackpressureLimitBytes, // 默认 16MB
